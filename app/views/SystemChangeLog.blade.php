...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById('chlog_date').value = formattedDate; 
    ...
    <div class="card" style="height: 650px; margin-top: 50px; background-color:rgb(222, 222, 223);">
        <div class="card-body" style="display: flex; max-width: 1350px; margin: auto; padding: 20px;">
            ...
            <div style="flex: 0 0 100%; padding-right: 20px;">
                ...
                <div style="display: flex; align-items: center; margin-top: 5px;">
                    ...
                    <input type="date" name="chlog_date" class="input-text" id="chlog_date" style="width: 100px">
                    ...
                    <label style="font-size: 16px; margin-left: 5px;"><b>User's UID </b></label>
                       <select name="labuser_uid" style="width: 180px; height: 30px; margin-left: 15px;" class="input-text" id="labuser_uid">
                    ...
                    <input type="button" style="flex: 0 0 80px; margin-left: 10px;" class="btn" id="log_ser_btn" value="Search" onclick="loadRecordToTable();">
                </div>
            </div>
        ...
        <div class="pageTableScope" style="display: flex; height: 500px; margin-top: 10px; width: 100%;">
            <div style="flex: 1; padding-right: 10px;">
                <table style="font-family: Futura, 'Trebuchet MS', Arial, sans-serif; font-size: 13pt;" id="change_logdataTable" width="100%" border="0" 
