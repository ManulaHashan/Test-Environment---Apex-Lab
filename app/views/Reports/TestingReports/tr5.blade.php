...
<div style="font-family:Arial, Helvetica, sans-serif; ">
    ...
    <blockquote>
        ...
        $tData = "";
        $result0 = DB::select("select d.tgid,d.name,d.comment from lps_has_test b,Lab_has_test c, Testgroup d where c.Testgroup_tgid = d.tgid and c.test_tid = b.test_tid and b.lps_lpsid='" . $lpsid . "' and d.Lab_lid = '" . $_SESSION['lid'] . "' group by d.tgid");
        foreach ($result0 as $res0) {
