...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="border:0px; padding: 0px; margin: 0px">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr >
                    <td id="User">
                      ...
                      <img src="../image/labUserLogin.jpg" width="660px" class="UMemLoginBack">
                          
                        <div id="userLogindiv" class="userLogindiv">
                            <%if((request.getParameter("login") != null) && (request.getParameter("login").equals("erroru"))){%>
                        ...
                        <%}%>
                            <table id="userLoginTbl" width="100%" border="0" cellpadding="0" cellspacing="0" class="loginDivTable">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><input type="submit" name="submit" Value = "LOGIN" class="LoginBtn"></td>
                                </tr>
                            </table>
                      </div>
                        <div class="userLogindivIco"><img src="../image/loginBtn.png" class="loginBtnIcon" onclick="naviDrop('userLogindiv')"></div>

                  </td>

                    <td id="Patient">

                      <img src="../image/PatientLogin.jpg" width="660px" class="PMemLoginBack">
                        
                        <div class="PLoginBackHead">Patient Login</div>
                        
                        <div id="PatientLogindiv" class="PatientLogindiv">
                            <%if((request.getParameter("login") != null) && (request.getParameter("login").equals("errorp"))){%>
                        <p style="color: red;">Wring Username or Password. Please try again!</p>
                        <%}%>
                        ...
                        <div class="PatientLogindivIco"><img src="../image/loginBtn.png" class="loginBtnIcon" onclick="naviDrop('PatientLogindiv')"></div>
      ...
      <tr valign="middle">
        ...
        <td class="menuBtn"><a class="menu_link" href="About.html">About</a></td>
        <td class="menuBtn"><a class="menu_link" href="Products.html">Products</a></td>
        <td class="menuBtn"><a class="menu_link" href="Features.html">Features</a></td>
        <td class="menuBtn"><a class="menu_link" href="Contact.jsp">Contact Us</a></td>
        <td class="menuBtn"><a class="menu_link" href="MembersArea.jsp">Members Area</a></td>
      </tr>
</table>
    </body>
</html>
